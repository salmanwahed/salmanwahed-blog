        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image_type",
                    models.CharField(
                        choices=[("BANNER", "Banner"), ("THUMB", "Thumbnail"), ("BASIC", "Basic")],
                        default="BASIC",
                        max_length=10,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "project_type",
                    models.CharField(
                        choices=[("MOBILE_APP", "Mobile Application"), ("WEB_APP", "")],
                        default="MOBILE_APP",
                        max_length=20,
                ...
                (
                    "status",
                    models.CharField(
                        choices=[("LIVE", "Live"), ("ONGOING", "Ongoing"), ("CLOSED", "Closed")],
                        default="LIVE",
                        max_length=20,
                    ),
                ),
